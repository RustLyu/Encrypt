...
std::string AesEncryptor::EncryptString(std::string strInfor) 
{
    ...
    char* pOut = new char[4 * (nLength + spaceLength)];
...
std::string AesEncryptor::DecryptString(std::string strMessage) {
